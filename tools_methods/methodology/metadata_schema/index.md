...
<div class="pagebody">
  ...
  <tr>
   <td>Location</td>
    ...
    <td>TAG</td>
    <td>Manual</td>
    <td>To identify where the item was captured as specifically as possible using format province (city), town, district. We maintain directory of Sudanese locations including standard transliterations of place names to ensure consistency.</td>
  </tr>
  <tr>
   <td>Coordinates</td>
    <td>VERIFICATION</td>
  ...
  <tr>
   <td>Existence of original</td>
    ...
    <td>MEMO</td>
    <td>Manual</td>
    <td>To indicate if the Sudanese Archive knows of where and who has the original copy of the file.</td>
  </tr>
  <tr>
   <td>Edited?</td>
    <td>VERIFICATION</td>
...
PROCESSING</td>
    <td>TEXT</td>
    <td>Automated</td>
    <td>To indicate the number of views the online item has when was collected. For example: How many views this video has got since it was uploaded and then preserved by the Sudanese Archive</td>
  </tr>
   <tr>
   <td>File Size</td>
    <td>COLLECTION, PRESERVATION,
...
PROCESSING</td>
  ...
  <tr>
   <td>Relevant?</td>
    ...
    <td>PICK</td>
    <td>Manual</td>
    <td>To indicate if the visual evidence is useful to be verified by the Sudanese Archive team</td>
  </tr>
  <tr>
   <td>Verified? </td>
    <td>VERIFICATION</td>
    <td>PICK</td>
    <td>Manual</td>
    <td>To indicate if the visual evidence has been verified by the Sudanese Archive team</td>
  </tr>
  <tr>
   <td>Public?</td>
    <td>PUBLICATION</td>
    <td>PICK</td>
    <td>Manual</td>
    <td>To indicate if the visual evidence is publicly available on the Sudanese Archive database. </td>
  </tr>  
   <tr>
   <td>Priority</td>
    <td>ANALYSIS</td>
    <td>PICK</td>
    <td>Manual</td>
    <td>To indicate the priority of the footage based on the information the Sudanese Archive have about the incident as well as other Sudanese human rights organisations.</td>
  </tr>  <tr>
   <td>Keywords</td>
    <td>ANALYSIS</td>
    <td>TAG</td>
...
PROCESSING
   ...
   <td>Collection</td>
    ...
    <li>Civilian casualties as a result of alleged attacks by Sudanese government forces</li>
    <li>Civilian casualties as a result of alleged attacks by pro-Sudanese government forces</li>
    <li>Plunder and theft</li>
    <li>Coalition airstrikes in Sudan</li>
    <li>Other</li>
</td>
  </tr>
<tr>
   <td>Armed group</td>
    ...
    <td>PICK</td>
    <td>Manual</td>
    <td>To provide the name of the armed group that is shown in the video or reported to be responsible for committing human rights violations in Sudan</td>
  </tr>
</tbody></table>
